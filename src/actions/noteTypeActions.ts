import API from "../api/NoteType";
import snackBarUpdate from "../actions/snackBarActions";
import { updateModal } from "../actions/modalActions";
import { ACTIONS } from '../interfaces/actionTypes/noteTypeTypes';
...
export const create = (body: object) => async (dispatch: Function) => {
  ...
  try {
    ...
    if (status === 200 || status === 201) {
      ...
      snackBarUpdate({
        payload: {
          message: "Tipo nota ha sido Creado!",
          type: "success",
          status: true
        }
      })(dispatch);
...
export const update = (body: object) => async (dispatch: Function) => {
  ...
  try {
    ...
    if (status === 200) {
      ...
      snackBarUpdate({
        payload: {
          message: "Tipo nota ha sido Actualizado!",
          type: "success",
          status: true
        }
      })(dispatch);
