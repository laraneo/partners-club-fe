import API from "../api/SharePermitMovement";
import snackBarUpdate from "../actions/snackBarActions";
import { updateModal } from "../actions/modalActions";
import { ACTIONS } from '../interfaces/actionTypes/sharePermitMovementTypes';
...
export const create = (body: object) => async (dispatch: Function) => {
  ...
  try {
    ...
    if (status === 200 || status === 201) {
      ...
      snackBarUpdate({
        payload: {
          message: "Permiso de movimiento de accion ha sido Creado!",
          type: "success",
          status: true
        }
      })(dispatch);
...
export const update = (body: object) => async (dispatch: Function) => {
  ...
  try {
    ...
    if (status === 200) {
      ...
      snackBarUpdate({
        payload: {
          message: "Permiso de movimiento de accion ha sido Actualizado!",
          type: "success",
          status: true
        }
      })(dispatch);
...
export const remove = (id: number) => async (dispatch: Function) => {
  try {
    ...
    if (status === 200) {
      ...
      snackBarUpdate({
        payload: {
          message: "Permiso de movimiento de accion Eliminado!",
          type: "success",
          status: true
        }
      })(dispatch);
