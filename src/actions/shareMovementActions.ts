...
export const create = (body: object) => async (dispatch: Function) => {
  ...
  try {
    ...
    if (status === 200 || status === 201) {
      ...
      snackBarUpdate({
        payload: {
          message: "Movimiento de Accion Creada!",
          type: "success",
          status: true
        }
      })(dispatch);
...
export const disableShare = (body: object) => async (dispatch: Function) => {
  dispatch({
    type: ACTIONS.SET_LOADING,
    payload: true
  });
  try {
    const response = await API.disableShare(body);
    const { status } = response;
    let createresponse: any = [];
    if (status === 200 || status === 201) {
      createresponse = response;
...
export const update = (body: object) => async (dispatch: Function) => {
  ...
  try {
    ...
    if (status === 200) {
      ...
      snackBarUpdate({
        payload: {
          message: "Movimiento de Accion Actualizada!",
          type: "success",
          status: true
        }
      })(dispatch);
...
export const remove = (id: number) => async (dispatch: Function) => {
  try {
    ...
    if (status === 200) {
      ...
      snackBarUpdate({
        payload: {
          message: "Movimiento de Accion Eliminada!",
          type: "success",
          status: true
        }
      })(dispatch);
